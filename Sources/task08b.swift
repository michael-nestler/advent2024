        ...
        func markAntinodes(currentPos: (Int, Int)) {
            ...
            if nextPos != nil {
                ...
                while true {
                    ...
                    var (antinodeARow, antinodeACol) = (currentRow - diffRow, currentCol - diffCol)
                    while antinodeARow >= 0 && antinodeARow < antennas.count && antinodeACol >= 0 && antinodeACol < antennas[antinodeARow].count {
                        antinodes[antinodeARow][antinodeACol] = true
                        antinodeARow = antinodeARow - diffRow
                        antinodeACol = antinodeACol - diffCol
                    }
                    var (antinodeBRow, antinodeBCol) = (nextRow + diffRow, nextCol + diffCol)
                    while antinodeBRow >= 0 && antinodeBRow < antennas.count && antinodeBCol >= 0 && antinodeBCol < antennas[antinodeBRow].count {
                        antinodes[antinodeBRow][antinodeBCol] = true
                        antinodeBRow = antinodeBRow + diffRow
                        antinodeBCol = antinodeBCol + diffCol
                    }
